...
const ClientTable_withAssignee = ({ clients, onEdit, onDelete, onChat, onBuild, onClientUpdate, onOtwStatusChange, onAssigneeChange }) => {
...
export default ClientTable_withAssignee;
